...
function Form() {
  return (
    <section className="darkmode bg-[#EEEEEE] lg:h-screen pb-10 lg:pb-16 2xl:pb-24 p-6 lg:px-40">
      <div className="darkmode bg-[#EEEEEE] mt-16 h-full flex justify-center flex-wrap">
        <div className="flex justify-center lg:pt-20 w-7/12">
          <div className="w-full flex justify-center">
            <img
              className="-ml-64  w-10/12 h-full object-cover"
              src={formimg}
            />
          </div>
        </div>
        <div className="w-full h-full lg:w-4/12 flex justify-between flex-col">
          <h4 className="text-xl text-center lg:text-4xl 2xl:text-5xl font-semibold py-1">
            Order Now
          </h4>
          <div className="dark:bg-[#202124] bg-white w-full h-70vh py-8 2xl:py-8 rounded-xl lg:rounded-2xl 2xl:rounded-3xl px-8 flex flex-col justify-between ">
            <div>

...
function Header(props) {
  ...
  return (
    <nav className="flex relative lg:flex-wrap items-center justify-between p-6 py-10 lg:py-3  dark:bg-[#202124] dark:text-white">
      <div className="flex 2xl:justify-start  items-center w-10/12 lg:w-6/12">
        ...
        <h1 className="lg:pr-24 2xl:pr-0 pl-5 montserrat font-semibold tracking-[10px] text-[35px] lg:text-2xl text-brand_gray dark:text-white">
          DIMENSIONLESS
        </h1>
      </div>
